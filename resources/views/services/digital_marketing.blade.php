        ...
        <div class="container">
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <img src="{{ asset('assets/images/seo-analytics.webp') }}" class="img-fluid"

                        alt="SEO and Analytics Services"  loading="lazy">
        ...
        <div class="container">
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-1">
                    ...
                    <img src="{{ asset('assets/images/social-influencer.webp') }}" class="img-fluid"

                        alt="Social Media and Influencer Marketing Services"  loading="lazy">
        ...
        <div class="container">
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <img src="{{ asset('assets/images/paid-conversions.webp') }}" class="img-fluid"

                        alt="Paid Advertising and Conversion Optimization Services"  loading="lazy">
        ...
        <div class="container">
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-1">
                    ...
                    <img src="{{ asset('assets/images/content-automation.webp') }}" class="img-fluid"

                        alt="Content Marketing and Automation Services"  loading="lazy">
