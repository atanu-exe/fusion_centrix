                 ...
                 <div class="row align-items-center g-4 g-lg-5">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <h1 class="fc-services-title">
                             ...
                             Digital solutions built for <strong>growth.</strong>
                 ...
                 <div class="row g-4">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card fc-service-card-dark">
                             ...
                             <a href="{{ route('services.web_app_development') }}" class="fc-service-link">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card">
                             ...
                             <a href="{{ route('services.e_commerce') }}" class="fc-service-link">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card">
                             ...
                             <a href="{{ route('services.digital_marketing') }}" class="fc-service-link">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card">
                             ...
                             <a href="{{ route('services.custom_software') }}" class="fc-service-link">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card">
                             ...
                             <a href="{{ route('services.ui_ux_design') }}" class="fc-service-link">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <article class="fc-service-card">
                             ...
                             <a href="{{ route('services.branding_identity') }}" class="fc-service-link">
