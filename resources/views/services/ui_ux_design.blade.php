        ...
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-2">
                    <img src="{{ asset('assets/images/ui-design.png') }}" class="img-fluid" alt="Web & Mobile UI Design">
                </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6 order-md-1">
                    <img src="{{ asset('assets/images/ux-research.png') }}" class="img-fluid"
                        alt="UX Research & Wireframing, User Journey Mapping">
                </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <!-- Image Column (right on desktop) -->
                <div class="col-md-6 order-md-2">
                    <img src="{{ asset('assets/images/prototyping.png') }}" class="img-fluid"
                        alt="Prototyping with Figma and Adobe XD">
                </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <!-- Image Column (left on desktop) -->
                <div class="col-md-6 order-md-1">
                    <img src="{{ asset('assets/images/design-system.png') }}" class="img-fluid"
