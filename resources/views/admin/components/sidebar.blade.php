            ...
            <div class="nav-section">
                ...
                @if (auth()->user()->hasModuleAccess('leads'))
                    <a href="{{ route('admin.leads.index') }}"
                        class="nav-link {{ request()->routeIs('admin.leads.*') && !request()->routeIs('admin.leads.import.*') ? 'active' : '' }}">
                    ...
                    @if (auth()->user()->hasPermission('leads.import'))
                        <a href="{{ route('admin.leads.import.form') }}"
                            class="nav-link {{ request()->routeIs('admin.leads.import.*') ? 'active' : '' }}">
                ...
                @if (auth()->user()->hasModuleAccess('email'))
                    <a href="{{ route('admin.email.campaigns.index') }}"
                        class="nav-link {{ request()->routeIs('admin.email.campaigns.*') ? 'active' : '' }}">
        ...
        @if (auth()->user()->hasModuleAccess('hrm'))
            <div class="nav-section">
                ...
                <a href="{{ route('admin.hrm.attendance.index') }}"
                    class="nav-link {{ request()->routeIs('admin.hrm.attendance.*') ? 'active' : '' }}">
                    <i class="fas fa-clock"></i>
                    <span>Attendance</span>
                </a>
                <a href="{{ route('admin.hrm.leaves.index') }}"
                    class="nav-link {{ request()->routeIs('admin.hrm.leaves.*') ? 'active' : '' }}">
                ...
                @if (auth()->user()->hasPermission('hrm.salary'))
                    <a href="{{ route('admin.hrm.salary.index') }}"
                        class="nav-link {{ request()->routeIs('admin.hrm.salary.*') ? 'active' : '' }}">
                ...
                @if (auth()->user()->hasPermission('hrm.leaves'))
                    <a href="{{ route('admin.hrm.leave-types.index') }}"
                        class="nav-link {{ request()->routeIs('admin.hrm.leave-types.*') ? 'active' : '' }}">
        ...
        @if (auth()->user()->hasModuleAccess('analytics'))
            <div class="nav-section">
                ...
                <a href="{{ route('admin.analytics.overview') }}"
                    class="nav-link {{ request()->routeIs('admin.analytics.overview') ? 'active' : '' }}">
                    <i class="fas fa-chart-line"></i>
                    <span>Overview</span>
                </a>
                <a href="{{ route('admin.analytics.realtime') }}"
                    class="nav-link {{ request()->routeIs('admin.analytics.realtime') ? 'active' : '' }}">
                    <i class="fas fa-broadcast-tower"></i>
                    <span>Real-time</span>
                </a>
                <a href="{{ route('admin.analytics.pages') }}"
                    class="nav-link {{ request()->routeIs('admin.analytics.pages') ? 'active' : '' }}">
                    <i class="fas fa-file"></i>
                    <span>Pages</span>
                </a>
                <a href="{{ route('admin.analytics.locations') }}"
                    class="nav-link {{ request()->routeIs('admin.analytics.locations') ? 'active' : '' }}">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1 ms-3">
                ...
                <p class="mb-0 text-muted small">
                    {{ ucwords(str_replace('_', ' ', auth()->user()->user_type ?? 'Admin')) }}</p>
            </div>
        </div>
    </div>
</aside>
