            ...
            <div class="card-body">
                <form action="{{ route('admin.leads.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" name="skip_duplicates" class="form-check-input" id="skipDuplicates" checked>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-success">{{ $import->successful_count }}</td>
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <pre class="bg-light p-2 rounded small">name,email,phone,company
John Doe,john@example.com,1234567890,ACME Inc
Jane Smith,jane@example.com,0987654321,XYZ Corp</pre>
