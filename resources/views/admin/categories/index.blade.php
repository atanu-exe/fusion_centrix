                    ...
                    <tbody>
                        @forelse($categories as $category)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            @if ($category->color)
                                                <div class="d-flex align-items-center">
                                                    <span class="me-1"
                                                        style="width: 12px; height: 12px; background: {{ $category->color }}; border-radius: 3px; display: inline-block;"></span>
                                ...
                                <td>
                                    <small
                                        class="text-muted">{{ Str::limit($category->description, 50) ?? 'No description' }}</small>
                                </td>
                                <td>
