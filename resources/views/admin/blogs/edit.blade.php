    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="navbar-nav ms-auto">
                <a class="nav-link" href="{{ route('blog.show', $blog->slug) }}" target="_blank">
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                        ...
                        <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    @if($blog->featured_image)
                                        <div class="mb-2">
                                            <img src="{{ asset($blog->featured_image) }}" alt="Current Featured" class="img-thumbnail" style="max-height: 150px;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($blog->thumbnail_image)
                                        <div class="mb-2">
                                            <img src="{{ asset($blog->thumbnail_image) }}" alt="Current Thumbnail" class="img-thumbnail" style="max-height: 150px;">
                                            <div><small class="text-muted">Current image</small></div>
                                        </div>
                                    @endif
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" id="meta_description" 
                                          ...
                                          rows="2" 
                                          placeholder="Leave blank to auto-generate from content">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_published" 
                                               id="publish_true" value="1" {{ old('is_published', $blog->is_published ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_published" 
                                               id="publish_false" value="0" {{ old('is_published', $blog->is_published ? '1' : '0') == '0' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="publish_false">
                                            <i class="fas fa-file-alt text-warning me-1"></i><strong>Draft</strong>
                                            <small class="d-block text-muted">Not visible to public</small>
                                        </label>
                                    </div>
                                </div>
                                <small class="text-muted mt-2 d-block">
                                    @if($blog->published_at)
                                        First published: {{ $blog->published_at->format('M d, Y h:i A') }}
                                    @else
                                        Not yet published
                                    @endif
                                </small>
                ...
                <div class="card shadow-sm mt-3">
                    <div class="card-body">
                        <h5 class="card-title text-muted"><i class="fas fa-chart-bar me-2"></i>Blog Stats</h5>
                        <div class="row text-center">
                            <div class="col-md-3">
                                <strong class="d-block">{{ number_format($blog->views) }}</strong>
                                <small class="text-muted">Views</small>
                            </div>
                            <div class="col-md-3">
                                <strong class="d-block">{{ $blog->shares ?? 0 }}</strong>
                                <small class="text-muted">Shares</small>
                            </div>
                            <div class="col-md-3">
                                <strong class="d-block">{{ $blog->created_at->format('M d, Y') }}</strong>
                                <small class="text-muted">Created</small>
                            </div>
                            <div class="col-md-3">
                                <strong class="d-block">{{ $blog->updated_at->diffForHumans() }}</strong>
