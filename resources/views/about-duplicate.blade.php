...
<style>
  ...
  @media (min-width: 992px) {
    ...
    .col-lg-3:last-child .step-box::after {
      display: none; /* remove arrow for last step */
    }
  }

  /* Colors */
  .step1 { border-top: 5px solid #66bb2b; }
  .step2 { border-top: 5px solid #f9b41b; }
  .step3 { border-top: 5px solid #00acc1; }
  .step4 { border-top: 5px solid #ad2a8d; }
