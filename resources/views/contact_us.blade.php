...
@section('content')
    ...
    <section class="py-5 text-center sub-hero">
        <div class="container">
            ...
            <p class="lead text-center">We're here to help. Reach out for project inquiries, partnerships, or just to <span
                    class="text-danger fw-bold">say hello</span>.</p>
        </div>
    </section>
    <!-- Contact Info & Form -->
    <section class="cnct_frm_sec pb-5">
        <div class="container">
            <div class="row gy-5 align-items-stretch">
                ...
                <div class="col-lg-5 m-0 mt-lg-5 order-2 order-lg-1">
                    <div class="bg-light p-4 shadow rounded h-100">
                        ...
                        <p><i class="fas fa-envelope me-2 text-primary"></i> sales@fusioncentrix.com</p>
                        <p><i class="fas fa-phone-alt me-2 text-primary"></i> +91 9477614409</p>
                        <h5 class="mt-4">Follow Us</h5>
                        <div class="d-flex gap-3 mt-2">
                            <a href="https://www.facebook.com/fusioncentrix" target="_blank" class="text-primary fs-4"><i
                                    class="fab fa-facebook"></i></a>
                            <a href="https://www.instagram.com/fusioncentrix" target="_blank" class="text-danger fs-4"><i
    ...
    <section class="py-5 bg-light wrkng_hrs">
        <div class="container">
            ...
            <div class="row justify-content-center text-center g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="p-4 bg-white shadow rounded h-100">
                        ...
                        <h5>Response Time</h5>
                        <p class="text-muted">We generally reply to all <b>inquiries within 24 hours</b>, no matter where
                            you are located.</p>
                    </div>
                </div>
            </div>
